                            ...
                            <div class="panel with-nav-tabs panel-default">
                                <div class="panel-heading">
                                    <ul class="nav nav-tabs">
														...
														<li><a href="#tab2default" data-toggle="tab">Regulon overview</a></li>
																																				...
																																				<div class="tab-pane {{if {{$sec0+1}} eq '1'}}active{{/if}}" id="regulon_main_CT{{$sec0+1}}" role="tabpanel">
																																						...
																																						<div class="flatPanel panel panel-default">
																																							...
																																							<select  id="rss_pvalue{{$sec0+1}}" class="selectpicker" name="rss_pvalue{{$sec0+1}}" data-width="auto">
																																								...
																																								<input style=""class="btn btn-default" type="button" value="Reload page using selected p-value" onClick="javascript:location.href = '/iris3/results_iris3.php?jobid={{$jobid}}&pvalue=' + $('#rss_pvalue{{$sec0+1}}').val();" />
																																							</div>
																																							<div class="CT-result-img">
																																								<div class="col-sm-12">
